...
class AppColors {
  ...
  static const Color bgPage = Color(0xFFFDF8F3);
  static const Color bgCard = Color(0xFFFFFFFF);
  static const Color bgTab = Color(0xFFEFE6DD);
  static const Color textPrimary = Color(0xFF4A3728);
  static const Color textSecondary = Color(0xFFA08070);
  static const Color brand = Color(0xFFC8765A);
  ...
  static const Color holiday = Color(0xFFC0504D);
  static const Color shadow = Color(0x0F4A3728);
}
